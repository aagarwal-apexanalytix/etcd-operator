...
func (in *AutoDefragSpec) DeepCopyInto(out *AutoDefragSpec) {
	*out = *in
	...
	if in.MinIntervalMinutes != nil {
		in, out := &in.MinIntervalMinutes, &out.MinIntervalMinutes
		*out = new(int32)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AutoDefragSpec.
func (in *AutoDefragSpec) DeepCopy() *AutoDefragSpec {
	if in == nil {
		return nil
	}
	out := new(AutoDefragSpec)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BackupSourcePVC) DeepCopyInto(out *BackupSourcePVC) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BackupSourcePVC.
func (in *BackupSourcePVC) DeepCopy() *BackupSourcePVC {
	if in == nil {
		return nil
	}
	out := new(BackupSourcePVC)
...
func (in *EtcdClusterSpec) DeepCopyInto(out *EtcdClusterSpec) {
	*out = *in
	...
	if in.AutoDefrag != nil {
		in, out := &in.AutoDefrag, &out.AutoDefrag
		*out = new(AutoDefragSpec)
		(*in).DeepCopyInto(*out)
	}
}
...
func (in *EtcdRestoreSpec) DeepCopyInto(out *EtcdRestoreSpec) {
	*out = *in
	...
	if in.StorageClassOverride != nil {
		in, out := &in.StorageClassOverride, &out.StorageClassOverride
		*out = new(string)
		**out = **in
	}
}
